...
storiesOf("Appointment", module)
  ...
  .add("Appointment with time", () => <Appointment time="3am" />)
  ...
  // Edit
  .add('Edit', () => <Form student={'Jor'} value={interviewers[1]} interviewers={interviewers} onChange={action('setInterviewer')} onSave={action('onSave')} onCancel={action('onCancel')}/>)